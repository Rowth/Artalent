  ...
  const DATA = [
    {
      ...
      title: 'First Item',
      image:
        'https://images.unsplash.com/photo-1561150169-371f366b828a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8YWxjb2hvbHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=600&q=60',
    },
    {
      ...
      <ScrollView contentContainerStyle={{flex: 1, backgroundColor: 'black'}}>
        ...
        {modalType === 'add' && (
          <Modal
            ...
            <BottomAlert onClickCornerButton={() => setModalVisible(false)} />
          </Modal>
        )}
      </ScrollView>
    </SafeAreaView>
